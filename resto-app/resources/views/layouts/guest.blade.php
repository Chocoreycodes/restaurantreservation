...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="bg-[#FEFAE0] shadow-md" x-data="{ isOpen: false }">
            <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
              <div class="flex items-center justify-between">
                <a class="text-xl font-bold text-[#B99470] md:text-2xl hover:text-[#A9B388]"
                  href="#">
                  Reservation System
                </a>
                <!-- Mobile menu button -->
              ...
              <div :class="isOpen ? 'flex' : 'hidden'"
                ...
                <a class="font-bold text-[#B99470] hover:text-[#A9B388]"
                  href="/">Home</a>
                <a class="font-bold text-[#B99470] hover:text-[#A9B388]"
        ...
        <div class="font-sans text-gray-800 antialiased min-h-screen bg-[#FEFAE0]">
            {{ $slot }}
        </div>
        <footer class="bg-[#5F6F52] border-t border-gray-200">
